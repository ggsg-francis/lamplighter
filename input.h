...
namespace input
{
	namespace key
	{
		...
		enum modkey : btui64
		{
			...
			// Utility unsets
			//unset_held = 0b0000000000000000000000000000000011111111111111111111111111111111, // Every held input
			unset_hits = 0b1111111111111111111111111111111100000000000000000000000000000000, // Every hit input
			//unset_all_ = 0b1111111111111111111111111111111111111111111111111111111111111111, // Every input
		};
	}
